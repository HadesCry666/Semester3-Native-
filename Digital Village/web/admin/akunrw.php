...
if (isset($_POST['simpan'])) {
    ...
    if (mysqli_num_rows($nikCheckResult) == 0) {
        ...
        $duplicateCheckSql = "SELECT * FROM master_rt_rw WHERE rw = '$rw' AND (rt = '' OR rt IS NULL) AND nik <> '$nik'";
        ...
        if (mysqli_num_rows($duplicateCheckResult) > 0) {
            ...
            if (mysqli_num_rows($nikDupCheckResult) > 0) {
                ...
                if ($op == 'edit') {
                    ...
                    try {
                        $conn->begin_transaction();
                        $sql2 = "INSERT INTO master_rt_rw (nik, nama, no_hp, rw)
                                VALUES ('$nik', '$nama', '$telepon', '$rw')";
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered border-light">
                        ...
                        <tbody style="text-align: left;">
                           <?php 
                            $sql2   =  "SELECT * FROM master_rt_rw WHERE rt IS NULL";
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1><?= isset($_GET['op']) && $_GET['op'] == 'edit' ? 'Edit Data RW' : 'Tambah Data RW' ?></h1>
                ...
                <form id="addDataForm" method="POST" action="">
                    ...
                    <div class="mb-3 row">
                        ...
                        <!-- <div class="col">
                            ...
                            <input type="text" class="form-control" id="rt" name="rt" value="" required>
                        </div> -->
                    </div>
                    <!-- <div class="mb-3">

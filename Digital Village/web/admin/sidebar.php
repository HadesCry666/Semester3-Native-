    ...
    <div class="wrapper">
        <aside id="sidebar" class="expand">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="masterkk.php" class="sidebar-link">
                        <i class="bi bi-people-fill"></i>
                        <span>Master Kartu Keluarga</span>
                    </a>
                </li>
                <li class="sidebar-item">
                    ...
                    <ul id="pengajuan-surat" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        ...
                        <!-- <li class="sidebar-item">
                            <a href="suratditolak.php" class="sidebar-link submenu-link">Surat Ditolak</a>
                        </li> -->
                    </ul>
                </li>
                <li class="sidebar-item">
                    <a href="#" class="sidebar-link has-dropdown" data-bs-toggle="collapse" data-bs-target="#master-akun"
                    ...
                    <ul id="master-akun" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="akunrw.php" class="sidebar-link submenu-link">Akun RW</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="akunrt.php" class="sidebar-link submenu-link">Akun RT</a>
                        </li>
                        <!-- <li class="sidebar-item">
                            <a href="akunuser.php" class="sidebar-link submenu-link">Akun User</a>
                        </li> -->
                    </ul>
                </li>
                ...
                <li class="sidebar-item">
                    <a href="mastersurat.php" class="sidebar-link">

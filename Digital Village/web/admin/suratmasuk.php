...
$sql2 = "SELECT * FROM `view_pengajuan_diajukan` WHERE status = 'Disetujui RW'";
...
if (isset($_POST['simpan'])) {
    ...
    if (isset($_POST['id_pengajuan'])) {
        ...
        $id_pengajuan = $_POST['id_pengajuan']; 
        $status = "Selesai";  // The new status to update
        ...
        if ($conn->query($query) === TRUE) {
            ...
            header("Location: suratmasuk.php?success=Status berhasil diperbarui menjadi Selesai.");
            exit;
        } else {

...
$query = "SELECT COUNT(*) AS total FROM master_pengajuan WHERE status = 'Disetujui RW'";
...
$query1 = "SELECT COUNT(*) AS total FROM master_pengajuan WHERE status = 'Selesai'";
        ...
        <div class="main p-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text">
                        <h1>Dashboard</h1>
                        <h6>Selamat Datang Admin Desa Digital</h6>
                    </div>
